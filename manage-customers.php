...
?>
    <section class="content-header">
        <!--<div><img src="images/pimage.jpg"></div>-->
        <h1>
            <?=$title?>
        ...
        <div class="col-md-12">
            ...
            <div class="box box-body">
                <div class="box-header with-border">
                    <button type="submit" class="btn btn-primary" id="btnNewCustomer">New Flight</button>&nbsp;
                    <button type="button" id="btnDelete" name="submit1" class="btn btn-danger">Delete Flight</button>
                </div>
