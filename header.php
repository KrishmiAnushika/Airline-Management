    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="index-1.php" class="logo">
                ...
                <span class="logo-mini"><b>Air</b>GO</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>AirGO</b>-System</span>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="images/anushika.JPG" class="user-image" alt="User Image">
                                <span class="hidden-xs">Anushika Krishani</span>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <img src="images/anushika.JPG" class="img-circle" alt="User Image">

                                    <p>
                                        Anushika Krishani - Web Developer
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="<?= ($title === "Manage Customers")? "active" : ""  ?>">
                        <a href="manage-customers.php?title=Manage Customers">
                            <i class="fa fa-users"></i> <span> Manage Flight</span>
                        </a>
                    </li>
                    <li class="<?= ($title === "Manage Items")? "active" : ""  ?>">
                        <a href="manage-items.php?title=Manage Items">
                            <i class="fa fa-list"></i><span> Manage Airline</span>
                        </a>
                    </li>
                    <li class="<?= ($title === "Place Orders")? "active" : ""  ?>">
                        <a href="manage-airport.php?title=Place Orders">
                            <i class="fa fa-dollar"></i><span> Manage Airport</span>
                        </a>
                    </li>
                    <li class="<?= ($title === "Place Orders")? "active" : ""  ?>">
                        <a href="place-order.php?title=Place Orders">
                            <i class="fa fa-dollar"></i><span> Manage Schedule</span>
                        </a>
                    </li>
